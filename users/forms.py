...
# widget are used to add additional attributes
class NewRegisterForm(UserCreationForm):
    ...
    username=forms.CharField(max_length=50, required=True,widget=forms.TextInput(attrs={'palceholder':'username','class':'form-control'}))
